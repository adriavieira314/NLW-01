...
const Detail = () => {
    ...
    //funcao para o whatsapp
    function handleWhatsapp() {
        Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Tenho interesse sobre a coleta de resíduos.`);
    }

    //FUNCAO PARAR OBTER O ID DO POINT VINDO DA ROTA POINTS
    const route = useRoute();
    //armazenando os dados do point
    const [data, setData] = useState<Data>({} as Data);
    //estou forcando o typescript a entendere que essa variavel tem o formato da interface Params
    const routeParams = route.params as Params;
    //funcao de captura do meu point selecionado
    useEffect(() => {
    ...
    //se data.point nao existir, nao vai me mostrar nada até o point carregar
    if(!data.point) {
        return null;
    }
